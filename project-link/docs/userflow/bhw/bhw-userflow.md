...
The BHW is a supervised field contributor. Official reporting authority remains with Midwife/PHN/PHIS roles.
...
3. PHIS performs data quality checks before export/submission.
...
5. Official reporting outputs are generated by authorized higher roles (Midwife/PHN/FHSIS Coordinator), not by BHW.
...
7. BHW cannot perform approval actions reserved for Midwife/PHN/PHIS.
